...
const dataProjects = [
  {
    title: "Housing Rights Initiative",
    description: "Interactive data visualizations and simulations communicating complex policy and voucher discrimination through audience-focused storytelling.",
    tags: ["data", "visualization", "policy"]
  },
  {
    title: "IGVC LIDAR Mapping",
    description: "Implementation of ROS and LIDAR sensor integration for real-time 3D environment mapping and autonomous navigation.",
    tags: ["mapping", "lidar", "autonomous"]
  }
];

export default function DataGeography() {
  return (
    <main className="min-h-screen px-6 md:px-12 py-12" style={{ fontFamily: '"Courier New", Courier, monospace' }}>
      ...
      <div className="max-w-screen-xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-16 uppercase">data + geography.</h1>
