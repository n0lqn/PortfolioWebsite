  ...
  const content = (
    <>
      {letters.map((char, i) => (
        <motion.span
          key={`${text}-${char}-${i}`}
          layoutId={`housing-rights-${text.replace(/\W/g, "-")}-char-${i}`}
      ...
      {underline && (
        <motion.div
          layoutId={`housing-rights-${text.replace(/\W/g, "-")}-underline`}
...
export default function HousingRights() {
  return (
    <motion.main
    ...
    >
      ...
      <div className="px-6 md:px-12 max-w-screen-xl mx-auto mb-24">
        <div className="mb-12 border-b border-foreground/10 pb-12">
          <DancingTitle
            text="housing rights initiative"
            level={1}
            underline
          ...
          <div className="space-y-2">
            <p className="text-sm opacity-50 tracking-widest leading-relaxed">
              advisors: <a href="https://www.shoushta.com/" className="hover:text-accent">professor tandis shoushtary</a> & professor samuel keene<br />
              spring 2026
            </p>
            <p className="text-xs font-bold tracking-[0.2em] opacity-60 uppercase mt-4">
              co-produced with: akis bouzoulas, amira walcott, kamai williams, myisha hassan, saskia lampe, sophia klymchuk
            </p>
          </div>
        </div>
        ...
        <div className="bg-accent/5 p-8 border-l-4 border-accent mb-16">
          <p className="text-lg font-medium leading-relaxed">
            this project was our final submission for <strong>ECE476: Data Science for Social Good</strong>. we collaborated with the <strong>housing rights initiative</strong> (<a href="https://www.housingrightsus.org/" target="_blank" className="hover:underline text-accent">housingrightsus.org</a>) to investigate section 8 housing voucher discrimination. by analyzing california housing datasets, we developed internal tools, audited data, and synthesized our findings into this interactive article.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-lg opacity-80 leading-relaxed">
                addressing systemic barriers in housing access through data-driven analysis and interactive design. our workflow spanned the full lifecycle from data manipulation and tool development to the final interactive presentation.
              </p>
            </div>

            <a 
              href="https://github.com/Akis-B/ECE476InteractiveArticle" 
              target="_blank" 
          ...
          <div className="space-y-8 bg-foreground/[0.02] p-8 rounded-lg border border-foreground/5">
            ...
            <ul className="space-y-6">
              <li className="flex flex-col gap-1">
                ...
                <p className="text-sm opacity-70">auditing section 8 housing voucher rejection patterns using comprehensive california datasets.</p>
              </li>
              <li className="flex flex-col gap-1">
                <span className="font-black text-sm tracking-wider underline underline-offset-4 decoration-accent/40 lowercase" style={{ fontFamily: '"Courier New", Courier, monospace' }}>
                  data pipeline
                </span>
                <p className="text-sm opacity-70">developing internal data manipulation tools to clean and normalize housing records for reproducible insights.</p>
              </li>
              <li className="flex flex-col gap-1">
                <span className="font-black text-sm tracking-wider underline underline-offset-4 decoration-accent/40 lowercase" style={{ fontFamily: '"Courier New", Courier, monospace' }}>
                  interactive storytelling
                </span>
                <p className="text-sm opacity-70">synthesizing complex findings into an accessible ui/ux design to increase public awareness of housing inequity.</p>
              </li>
            </ul>
          </div>
        </div>
          ...
          <div className="w-full h-[120vh] bg-background border border-foreground/20 shadow-2xl rounded-lg overflow-hidden flex flex-col">
            <div className="bg-foreground/5 border-b border-foreground/10 p-3 flex items-center justify-between">
              ...
              <div className="text-[10px] tracking-widest font-bold opacity-60">
                housing rights initiative interactive article
              </div>
              <a 
                href="https://ece-476-interactive-article.vercel.app/" 
                target="_blank" 
                rel="noopener noreferrer"
            ...
            <div className="flex-1 bg-white">
              <iframe 
                src="https://ece-476-interactive-article.vercel.app/" 
                className="w-full h-full border-none"
                title="Housing Rights Initiative Preview"
              />
            </div>
          </div>
        </div>
