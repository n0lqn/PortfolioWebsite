...
const projects = [
  {
    title: "MeshMind",
    description: "A privacy-first local AI network with a semantically shared prompt marketplace. Built with Spring Boot, FastAPI, and pgvector.",
    github: "https://github.com/Isaacamar/meshmind",
    tags: ["ai", "distributed-systems", "vector-search"]
  },
  {
    title: "Interactive Article (ECE476)",
    description: "An immersive, interactive digital article exploring complex systems through high-fidelity UI and motion design.",
    github: "https://github.com/Akis-B/ECE476InteractiveArticle",
  ...
  return (
    <main className="min-h-screen px-6 md:px-12 py-12" style={{ fontFamily: '"Courier New", Courier, monospace' }}>
      ...
      <div className="max-w-screen-xl mx-auto">
        <h1 className="text-5xl md:text-7xl font-bold tracking-tighter mb-16 uppercase">software + interfaces.</h1>
